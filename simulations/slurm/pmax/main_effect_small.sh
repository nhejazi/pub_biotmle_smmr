#!/bin/bash
# Job name:
#SBATCH --job-name=biotmle_sim_max_findings_main_small_effect
#
# Working directory:
...
R CMD BATCH --no-save --no-restore \
  '--args sim_type=true_findings cv_folds=1 sl_spec=main prop_genes=0.5 effect_size=small' \
  R/03_run_sim_sl.R logs/pmax/03e_effect_small_sl_main.Rout
