#!/bin/bash
# Job name:
#SBATCH --job-name=biotmle_sim_max_findings_main_yes_g0prob
#
# Working directory:
...
R CMD BATCH --no-save --no-restore \
  '--args sim_type=true_findings cv_folds=1 sl_spec=main prop_genes=0.5 positivity_issues=yes' \
  R/03_run_sim_sl.R logs/pmax/03c_g0prob_yes_sl_main.Rout
