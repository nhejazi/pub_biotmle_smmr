#!/bin/bash
# Job name:
#SBATCH --job-name=cv_biotmle_sim_min_findings_main_yes_g0prob
#
# Working directory:
...
R CMD BATCH --no-save --no-restore \
  '--args sim_type=true_findings cv_folds=2 sl_spec=main prop_genes=0.1 positivity_issues=yes' \
  R/03_run_sim_sl.R logs/pmin/03d_g0prob_yes_sl_main_cv.Rout
