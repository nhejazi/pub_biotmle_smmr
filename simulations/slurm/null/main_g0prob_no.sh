#!/bin/bash
# Job name:
#SBATCH --job-name=biotmle_sim_global_null_main_no_g0prob
#
# Working directory:
...
R CMD BATCH --no-save --no-restore \
  '--args sim_type=global_null cv_folds=1 sl_spec=main' \
  R/03_run_sim_sl.R logs/null/03a_g0prob_no_sl_main.Rout
