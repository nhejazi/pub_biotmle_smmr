#!/bin/bash
# Job name:
#SBATCH --job-name=biotmle_sim_global_null_main_yes_g0prob
#
# Working directory:
...
R CMD BATCH --no-save --no-restore \
  '--args sim_type=global_null cv_folds=1 sl_spec=main positivity_issues=yes' \
  R/03_run_sim_sl.R logs/null/03c_g0prob_yes_sl_main.Rout
